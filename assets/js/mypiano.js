$(function(){
	...
	$('#upload').click(function(){
		var s = window.jsInterface.upload();
...
function translateNoteToKey(s){
	...
	console.log("translate key "+ s);
	var note = KeyNoteMap.keyToNote[s].toString;
	console.log("translate note" + note);
	return(note);
}
