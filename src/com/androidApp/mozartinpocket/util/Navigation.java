...
import com.androidApp.mozartinpocket.musiclist.MusicItemList;
import com.androidApp.mozartinpocket.musiclist.MusicsListActivity;
import com.androidApp.mozartinpocket.post.PostActivity;
import com.androidApp.mozartinpocket.profile.UserProfileActivity;
import com.androidApp.mozartinpocket.share.ShareActivity;

public class Navigation {
	public static void logout(Activity activity) {
		Intent intent = new Intent(activity, LoginActivity.class);
		MusicItemList.musicItemList.clear();
		MusicItemList.musicMap.clear();
