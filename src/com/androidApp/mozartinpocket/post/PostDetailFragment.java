...
import com.androidApp.mozartinpocket.musiclist.MusicsDetailFragment;
...
import com.androidApp.mozartinpocket.util.GPSTracker;
...
//						String latitude = Double.toString(gpsTracker.getlatitude());
	...
	public void onDestroy() {
	 ...
	 private Post newPost(){
		 ...
		 Log.w("post",newPost.getLongitude() + "//" +newPost.getLatitude());
		 return(newPost);
